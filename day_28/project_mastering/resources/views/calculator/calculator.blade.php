                ...
                <div class="col-md-8 mx-auto">
                    <div class="card card-body bg-info">
                        <form action="{{route('get-calculator-result')}}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="" class="col-md-4 col-form-label">LastNumber</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" readonly class="form-control" value="{{ Session::has('result') ? Session::get('result') : '' }}"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="submit" class="btn btn-success btn-block float-right " value="Get Result"/>
                                </div>
